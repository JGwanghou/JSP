...
<html>
	<head>
		...
		<!-- 
			...
			자바빈(JavaBean)
			 - 일반적으로 JSP에서 사용하는 데이터 전송객체
			 - form, db table의 필드(속성)를 멤버로 갖는 클래스
			 - MVC 모델과 Spring에서 자바빈을 VO객체(Value Object) 또는 DTO객체(Data Transfer Object)라고 부름
		 -->
	</head>
	<body>
		...
		<form action="./proc/addUser.jsp" method="post">	
			<table border="1">
				...
				<tr>
					...
					<label><input type="checkbox" name="hobby" value="축구"/>축구하기</label>
					</td>
				</tr>
				<tr>
